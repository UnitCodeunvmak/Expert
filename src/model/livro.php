...
class Livro
{
  ...
  function editarBook($id, $titulo, $autor, $editora, $ano, $categoria){
    $mysqli = new Conn();
    $titulo = $mysqli->getConnection()->real_escape_string($titulo);
    $autor = $mysqli->getConnection()->real_escape_string($autor);
    $editora = $mysqli->getConnection()->real_escape_string($editora);
    ...
    $sql = "UPDATE livro SET titulo='$titulo', autor='$autor', editora='$editora', ano='$ano', categoria='$categoria' WHERE id='$id'";
